...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Macao_cold_match"))
    ...
    #     db.setDatabaseName("macao_cold_match")
    ...
    #         # 打开失败
    #         return db.lastError()
    #     print("连接至 macao_cold_match success!")
    #     # 创建QsqlQuery对象，用于执行sql语句
    #     query = QtSql.QSqlQuery()
    #     # 查询出刚才更新的表
    #     table_name = 'macao_cold_match' + nowatime
